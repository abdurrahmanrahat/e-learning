...
const Hero = () => {
  return (
    <div className="container-class flex justify-between items-center py-16">
      {/* left side */}
      <div className="w-1/2">
        <div className="flex flex-col gap-14 justify-start ">
          <div className="flex flex-col gap-8">
            <h2 className="text-6xl text-[#101828] font-semibold leading-[1.2em]">
              Up your <span className="text-primary">skills</span> <br /> to <span className="text-primary">advance</span> your <span className="text-primary">career</span> path
            </h2>
