...
const Testimonials = () => {
      ...
      return (
            <div className="relative py-10 w-full bg-fixed bg-cover bg-center bg-[url('https://i.ibb.co.com/8K7yhTB/16041.jpg')]">
                  {/* Overlay */}
                              ...
                              >
                                    <section className="relative z-10 dark:bg-gray-100 dark:text-gray-800">
                                          <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
                                                ...
                                                <p className="px-6 py-2 text-2xl text-white font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl">{testimonial?.testimonial}</p>
                                                <div className="flex justify-center space-x-3">
                                                      <img src={testimonial?.profilePic} alt="" className="w-20 h-20 bg-center bg-cover rounded-md" />
                                                      <div>
                                                            <p className="leading-tight text-white text-start font-medium">{testimonial?.name}</p>
