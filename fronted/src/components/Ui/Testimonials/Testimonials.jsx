      ...
      return (
            <div className="relative py-8 mt-10 lg:mt-20 w-full bg-fixed bg-cover bg-center bg-[url('https://i.ibb.co/8K7yhTB/16041.jpg')]">
                  ...
                  <div className="custom-prev absolute left-4 top-1/2 transform -translate-y-1/2 z-20 cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-white bg-[#00CBB8] rounded-full">
                              ...
                              >
                                    <section className="relative z-10 dark:bg-gray-100 dark:text-gray-800">
                                          <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
                                                ...
                                                <p className="px-6 py-2 text-white font-semibold text-center font-nunito text-xl md:text-2xl lg:text-2xl lg:max-w-2xl xl:max-w-5xl">{testimonial?.testimonial}</p>
