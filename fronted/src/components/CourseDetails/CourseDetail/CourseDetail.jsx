...
import TabsLgBasic from "../TabsLgBasic/TabsLgBasic";
...
"
          ...
          <div className="mb-7">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="">
                <img src="https://i.ibb.co.com/0rx87WR/instagram.png" alt="" />
              </a>
              <a href="">
...
"
              ...
              <button className="text-xl underline font-semibold text-gray-400">
                Learn more
              </button>
            </div>
          </div>
          <div className="w-full lg:w-[50%]  relative">
            <div className="">
              <img
                className="lg:w-[200px] lg:h-[200px] md:w-[200px] md:h-[200px] w-[100px] pt-6"
                src="https://i.ibb.co.com/7KvsnXp/Rectangle-18.png"
                alt=""
              />
              <div className="flex justify-end lg:mt-16 md:mt-28 mt-[60px]">
                <img
                  className="lg:w-[200px] lg:h-[200px] md:w-[200px] md:h-[200px] w-[100px]"
                  src="https://i.ibb.co.com/YbmwDHs/Rectangle-17.png"
                  alt=""
                />
              </div>
            </div>
            <div className="absolute lg:top-10 top-10 lg:left-5 md:left-6 left-5">
              <img
                className="w-[340px] lg:w-[610px] md:w-[680px] "
                src="https://i.ibb.co.com/5rQWTGN/Group-17.png"
                alt=""
              />
            </div>
          </div>
